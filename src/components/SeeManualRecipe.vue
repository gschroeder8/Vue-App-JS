          ...
          <form @submit.prevent="saveChanges">
            ...
            <div class="mb-3">
              ...
              <div class="d-flex mb-3">
                <input type="text" v-model="newIngredientName" class="form-control me-2"
            ...
            <div class="mb-3">
              ...
              <textarea v-model="editableRecipe.instructions" class="form-control" id="recipeInstructions" rows="4"
                required></textarea>
            </div>
